        ...
        <>
            ...
            <div className="flex flex-col w-[70%] mx-[15%] mt-[50px] gap-4 mb-6">
                <Link href={"/posts/sdas-21312-asda"}>
                    <a>
                        <div className="flex flex-col jusify-center px-9 pt-3 pb-4 border-b-2 border-green-400 hover:brightness-75 transition-all">
                            ...
                            <div className="flex justify-end items-center">
                                <BsFillHeartFill className="w-[29px] h-[29px] text-[#df3131] hover:brightness-125 mb-1 mr-1" />
                                <span>200</span>
                            </div>
                        </div>
                    </a>
